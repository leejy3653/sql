...
select 
sum(case gender when 'm' then 1 else 0 end)as 남직원,
...
from titles
where title='manager' and to_date>'9998-12-31';
...
-- 문제8
-- 현재 급여가 120,000이상 받는 사원은 몇 명이나 있습니까? 8297명
select count(emp_no)
from salaries
where salary>='120000';
...
select count(emp_no) as "Engineer 직책의 사원 수"
from titles
