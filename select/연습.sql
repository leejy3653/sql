...
select a.title as 직책, avg(b.salary)as 평균연봉, count(a.emp_no) as 인원수
...
select b.dept_name as 부서명, a.title as 직책, avg(c.salary) as 평균연봉
from titles a, departments b, salaries c
